...
public class SaleController {
    ...
    public ResponseEntity<?> makeSale(@RequestBody SaleDTO saleDTO){
        ...
        //si el usuario no existe
            Map<String,String> errorUsuario = new HashMap<>();
            errorUsuario.put("message","No se ha encontrado un usuario valido");
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body(errorUsuario);
            }
